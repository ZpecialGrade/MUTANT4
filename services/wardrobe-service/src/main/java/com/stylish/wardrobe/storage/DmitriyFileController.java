...
public class DmitriyFileController {
	private final DmitriyStorageService storageService;

	public DmitriyFileController(DmitriyStorageService storageService) {
	...
	public ResponseEntity<InputStreamResource> download(@PathVariable String objectKey) {
		DmitriyStorageService.StoredObject obj = storageService.getObject(objectKey);
