...
class ActivityServiceTest {
	...
	void record_persistsEvent() {
		...
		service.record(userId, ActivityType.ITEM_CREATED, target, "jeans");
		...
		assertThat(saved.getType()).isEqualTo(ActivityType.ITEM_CREATED);
	...
	void record_swallowsRepositoryFailure() {
		...
		service.record(UUID.randomUUID(), ActivityType.ITEM_DELETED, null, null);
	}
